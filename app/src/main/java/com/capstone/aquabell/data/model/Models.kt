...
object SensorInterval {
    const val pH = 60
    const val dissolvedOxygen = 15
    const val waterTemp = 10
    const val airTemp = 60
    const val airHumidity = 60
    const val turbidityNTU = 30
}
